const config = {
    ...
    specs: [
        [
            './test/specs/test-cookie-for-settings.js',
            './test/specs/test-cookie-settings.js',
        ],
        [
            './test/specs/test-accept-cookie-modal.js',
            './test/specs/test-million-more-page.js',
        ],
        [
            './test/specs/test-accept-cookie-modal.js',
            './test/specs/test-million-more-interactions.js',
        ],
    ],
    // Patterns to exclude.
    exclude: [
